...
protocol SuggestedCellProtocol: AnyObject {
    func setCount(_ count: Int)
    func setIsAddToBasketDidTap(_ isAddToBasketDidTap: Bool)
}

final class CartSuggestedCollectionViewCell: UICollectionViewCell {
    
    var cellPresenter: SuggestedCellPresenterProtocol! 
     var cartView: CartViewControllerProtocol?
    ...
    func configure(productSuggested: ProductElement) {
            productImageView.downloadImage(urlString: productSuggested.imageURL ?? productSuggested.squareThumbnailURL ?? "")
            priceLabel.text = productSuggested.priceText
            productNameLabel.text = productSuggested.name
            attributeLAbel.text = productSuggested.shortDescription ?? productSuggested.attribute
    }
...
extension CartSuggestedCollectionViewCell: SuggestedCellProtocol {
    func setIsAddToBasketDidTap(_ isAddToBasketDidTap: Bool) {
