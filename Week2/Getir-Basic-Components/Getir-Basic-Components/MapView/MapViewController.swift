...
class MapViewController: UIViewController {
    ...
    func checkLocationServices() {
        if CLLocationManager.locationServicesEnabled() {
            ...
            openSettings() // Bu fonksiyon aracılığıyla kullanıcı ayarlara yönlendirilir.
        }
    }
...
// Çözüm: Custom location enlem ve boylam verdim konumumu aldım. 36.854952680451746, 28.270872471306326
