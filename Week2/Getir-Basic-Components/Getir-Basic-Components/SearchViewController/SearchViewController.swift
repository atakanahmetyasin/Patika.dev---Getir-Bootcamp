...
class SearchViewController: UIViewController {
    ...
    var nothingToShow: Bool {
        filteredUsers.isEmpty && !isSearchBarEmpty
    }
    ...
    func filterContextForSearchText(_ searchText: String) {
        ...
        noDataLabel.isHidden = !nothingToShow
    }
...
// CEVAP: noDataLabel ve nothingToShow oluşturup gerekli işlemleri yaptım. search sonucu bulunamayınca ekranda "There is no data" yazıyor.
